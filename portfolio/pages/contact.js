	...
	return (
		<div className={styles.container}>
			...
			<Head>
				...
				<meta name="title" content="Contact | Muhammad Fauzan Aristya Putra"/>
			...
			{/* Homepage */}
			<motion.div initial={{opacity: 1}} exit={{opacity: 0}} transition={{duration: 0}} className={styles.contact}>
